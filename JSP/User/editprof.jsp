			...
			if(no==0)
			{
				%>
					...
					<div align="center" style="position: absolute;top: 320px;left: 220px;">
						 ...
						 <input type="image" value="submit" src="<%=request.getContextPath()%>/img/update1.png" alt="submit Button" onMouseOver="this.src='<%=request.getContextPath()%>/img/update1.png'" width="35%" height="10%"/>
					 </div>
